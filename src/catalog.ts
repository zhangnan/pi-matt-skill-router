...
export const catalog: readonly RouteDefinition[] = [
	...
	engineering("codebase-design", "The request concerns module depth, public interfaces, seams, adapters, or code boundaries rather than business terminology.", ["codebase design", "deep module", "module boundary", "interface design", "design an interface", "api design", "seam", "adapter", "模块边界", "深模块", "接口设计", "设计接口", "可测试性"], "discovery"),
	...
	engineering("domain-modeling", "The request changes domain terminology, ubiquitous language, glossary, CONTEXT.md, or ADRs.", ["domain model", "domain modeling", "ubiquitous language", "glossary", "context.md", "adr", "领域模型", "共同语言", "统一术语", "业务术语", "决策记录", "词汇表"], "discovery"),
	engineering("grill-with-docs", "A repository-scoped plan or product decision needs sustained clarification plus durable ADR/glossary updates.", ["grill with docs", "clarify with docs", "澄清并写文档", "带文档澄清", "访谈并沉淀", "写 adr", "沉淀 glossary"], "discovery"),
	...
	engineering("prototype", "A disposable runnable experiment is needed to answer a UI, logic, or state-model design question before production work.", ["prototype", "proof of concept", "poc", "spike", "throwaway", "原型", "概念验证", "丢弃式", "状态机验证", "ui 原型"], "discovery"),
	...
	engineering("to-spec", "Settled discussion needs to be synthesized into a coherent implementation spec; no more interviewing unless blocked.", ["to spec", "write a spec", "create spec", "specification", "prd", "product requirements", "形成规格", "写规格", "整理成 spec", "产品需求文档", "需求文档"], "synthesis"),
	...
	productivity("wait-what", "The user says the previous explanation did not land and wants an immediate plain-language re-explanation.", ["wait what", "i don't get it", "explain again", "没听懂", "重新解释", "再说一遍", "什么意思", "听不懂"]),
